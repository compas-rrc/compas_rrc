...
then invoke it using [`CustomInstruction`][compas_rrc.CustomInstruction] specifying
instruction name and appropriate parameters. If the procedure generates feedback,
it will be made available as the return value of the call.
...
!!! note
    ...
    For additional help, check the
    [ABB Reference Manual](https://library.e.abb.com/public/b227fcd260204c4dbeb8a58f8002fe64/Rapid_instructions.pdf).

## ::: compas_rrc.CustomInstruction
